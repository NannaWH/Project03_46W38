...
def load_and_clean_data(filename:str): 
    ...
    #Converting the hour variable into a "circle" (a full circle of 360 degrees = 2 * pi radians )
    ...
    # Lag power output variables 1–6
    for i in range(1, 7):
    ...
    #Add additional variables that can be useful for prediction
...
def data_split(data, splittype, prediction_horizon):
    ...
    Returns:
        X_train: training dataset (the data the machine learning models are tested on) including the explanatory variables i.e., lagged power output and wind and weather data. 
